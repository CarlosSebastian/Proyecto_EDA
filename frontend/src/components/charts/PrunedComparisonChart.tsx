...
interface PrunedComparisonChartProps {
  results: ExperimentResult[];
  bounds: string[];
}

export const PrunedComparisonChart: React.FC<PrunedComparisonChartProps> = ({
  results,
  bounds,
}) => {
      ...
      <Box sx={{ mt: 2 }}>
        <ResponsiveContainer width="100%" height={400}>
          <BarChart data={chartData}>
            ...
            <YAxis label={{ value: 'Series Podadas', angle: -90, position: 'insideLeft' }} />
            <Tooltip />
            <Legend />
